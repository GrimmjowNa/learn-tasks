...
- [backbone](http://backbonejs.org/#),[翻译](http://www.css88.com/doc/backbone/#)
- [ecmascript6](http://javascript.ruanyifeng.com/advanced/ecmascript6.html#toc0)
...
- [Aconda](https://www.cnblogs.com/zlslch/p/7975791.html)

## Python-C

- [用C语言扩展Python的功能](https://www.ibm.com/developerworks/cn/linux/l-pythc/index.html)
- [Python/C API Reference Manual](https://docs.python.org/3/c-api/#python-c-api-reference-manual)
- [Creating extensions without third party tools](https://docs.python.org/3/extending/index.html)
...
- [Rules](https://github.com/DavidAnson/markdownlint/blob/v0.11.0/doc/Rules.md#md002)
...
- [ssh timeout](https://bjornjohansen.no/ssh-timeout)
